...
# YOUR CODE HERE
wizard_school = "#{name} must not return to Hogwarts!"
...
#I used the data type that fit what the variable was describing
# Explain.
#For a first name a word would be used so a string data type, for being hungry you either are or aren't
#so a boolean for true/false, and then for the last one that's just an integer number for how many pets
